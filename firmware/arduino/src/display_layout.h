...
static constexpr int INSIDE_ROW2[4] = {   6,  78, 118, 12};
static constexpr int OUT_TEMP[4] = { 129,  36,  94, 28};
static constexpr int WEATHER_ICON[4] = { 210,  22,  28, 28};
...
static constexpr int FOOTER_WEATHER[4] = { 170,  90,  74, 32};
...
static_assert(INSIDE_ROW2[0] >= 0 && INSIDE_ROW2[1] >= 0, "INSIDE_ROW2 origin");
static_assert(6 + 118 <= EINK_WIDTH,  "INSIDE_ROW2 width");
static_assert(78 + 12 <= EINK_HEIGHT, "INSIDE_ROW2 height");
...
static_assert(210 + 28 <= EINK_WIDTH,  "WEATHER_ICON width");
static_assert(22 + 28 <= EINK_HEIGHT, "WEATHER_ICON height");
...
static_assert(170 + 74 <= EINK_WIDTH,  "FOOTER_WEATHER width");
