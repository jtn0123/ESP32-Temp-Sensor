...
#define LAYOUT_MD5 "802fe7870d7c85ef848fa22fc1b2dbf2"
...
static constexpr int RECT_INSIDE_PRESSURE[4] = {   6,  73, 115, 14};
...
static_assert(73 + 14 <= DISPLAY_HEIGHT, "INSIDE_PRESSURE height");
