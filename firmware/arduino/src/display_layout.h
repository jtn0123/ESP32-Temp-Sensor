...
// md5: bb3883679b3fcececa01009508d45a06
#pragma once
...
static constexpr int OUT_TEMP[4] = { 127,  36,  94, 28};
...
static constexpr int OUT_ROW2_L[4] = { 131,  80,  44, 12};
static constexpr int OUT_ROW2_R[4] = { 177,  80,  44, 12};
static constexpr int STATUS_[4] = {   6, 112, 238, 10};
static constexpr int FOOTER_L[4] = {   6,  94, 160, 28};
static constexpr int FOOTER_R[4] = { 170,  94,  74, 28};
...
static_assert(127 + 94 <= EINK_WIDTH,  "OUT_TEMP width");
