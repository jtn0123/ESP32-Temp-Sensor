...
#define LAYOUT_CRC 0x369D88FBu
#define LAYOUT_MD5 "861862ec343d3498079ad4d48212a6a8"
...
static constexpr int RECT_INSIDE_PRESSURE[4] = {   6, 105, 115, 14};
...
static_assert(105 + 14 <= DISPLAY_HEIGHT, "INSIDE_PRESSURE height");
