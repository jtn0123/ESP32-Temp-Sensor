...
static constexpr int INSIDE_PRESSURE[4] = {   6,  75, 115, 14};
static constexpr int OUT_TEMP[4] = { 129,  36,  94, 28};
static constexpr int WEATHER_ICON[4] = { 170,  92,  30, 28};
static constexpr int OUT_PRESSURE[4] = { 177,  68,  64, 14};
...
static_assert(75 + 14 <= EINK_HEIGHT, "INSIDE_PRESSURE height");
...
static_assert(68 + 14 <= EINK_HEIGHT, "OUT_PRESSURE height");
