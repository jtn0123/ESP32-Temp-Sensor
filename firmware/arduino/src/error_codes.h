...
#define SET_ERROR(code)                                                                       \
  do {                                                                                        \
    ...
    g_error_count++;                                                                          \
    LOG_ERROR("Error %d: %s at %s:%d (heap=%d)", (code), error_to_string(code), __FUNCTION__, \
              __LINE__, g_last_error.free_heap);                                              \
  } while (0)
...
#define LOG_AND_RETURN_ERROR(code, fmt, ...) \
  do {                                       \
...
inline const char* error_to_string(ErrorCode code) {
  switch (code) {
    ...
    case ERR_WIFI_TIMEOUT:
      return "WiFi timeout";
    case ERR_WIFI_INVALID_SSID:
      return "Invalid WiFi SSID";
    case ERR_WIFI_INVALID_PASSWORD:
      return "Invalid WiFi password";
    case ERR_WIFI_NO_AP_FOUND:
      return "No WiFi AP found";
    ...
    case ERR_MQTT_BUFFER_OVERFLOW:
      return "MQTT buffer overflow";
    case ERR_MQTT_INVALID_TOPIC:
    ...
    case ERR_SENSOR_NOT_FOUND:
      return "Sensor not found";
    case ERR_SENSOR_INVALID_DATA:
      return "Invalid sensor data";
    case ERR_SENSOR_TIMEOUT:
      return "Sensor timeout";

    // Battery errors
    case ERR_BATTERY_GAUGE_FAILED:
      return "Battery gauge failed";
    case ERR_BATTERY_LOW:
      return "Battery low";
    case ERR_POWER_RAIL_FAILED:
      return "Power rail failed";
    ...
    case ERR_DISPLAY_UPDATE_FAILED:
      return "Display update failed";
    case ERR_DISPLAY_BUSY_TIMEOUT:
      return "Display busy timeout";

    // System errors
    case ERR_NVS_INIT_FAILED:
      return "NVS init failed";
    case ERR_NVS_READ_FAILED:
      return "NVS read failed";
    case ERR_NVS_WRITE_FAILED:
      return "NVS write failed";
    case ERR_RTC_INIT_FAILED:
      return "RTC init failed";
