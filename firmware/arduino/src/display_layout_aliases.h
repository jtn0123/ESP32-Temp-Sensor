...
#define INSIDE_LABEL (::RECT_INSIDE_LABEL)
...
#define OUTSIDE_LABEL (::RECT_OUTSIDE_LABEL)
...
#define FOOTER_BATTERY (::RECT_FOOTER_BATTERY)
#define FOOTER_STATUS \
  (::RECT_FOOTER_IP)  // Legacy alias - RECT_FOOTER_STATUS renamed to RECT_FOOTER_IP
