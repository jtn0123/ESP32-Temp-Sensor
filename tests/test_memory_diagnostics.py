...
class TestMemoryDiagnostics:
    ...
    def test_memory_diagnostics_structure(self):
        ...
        diag = self.create_memory_diagnostics(
            free_heap=45000,
            min_heap=32000,
            largest_block=28000
        )
    ...
    def test_memory_threshold_alerts(self):
        ...
        # Test critical level
        assert self.check_memory_threshold(8000, critical_threshold, warning_threshold) == "critical"
        
        # Test warning level
        assert self.check_memory_threshold(15000, critical_threshold, warning_threshold) == "warning"
