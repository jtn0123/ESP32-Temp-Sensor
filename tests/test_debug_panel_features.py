...
class TestDebugPanelCore:
    ...
    def test_debug_panel_structure(self):
        ...
        for functionality in required_functionality:
            assert functionality.lower() in js_content.lower(), \
    ...
    def test_performance_monitor_metrics(self):
        ...
        for metric in metrics:
            assert metric.lower() in js_content.lower(), f"Performance metric concept '{metric}' not found"
    ...
    def test_test_scenario_categories(self):
        ...
        for category in categories:
            assert category in js_content or category.replace(' ', '_').lower() in js_content.lower(), \
...
class TestIconTester:
    ...
    def test_all_weather_icons(self):
        ...
        for icon in icons:
            ...
            assert '-' in icon or icon in ['rain', 'snow', 'sleet', 'wind', 'fog', 'cloudy', 'hail', 'thunderstorm'], \
