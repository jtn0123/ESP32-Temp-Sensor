...
def _get_config_topics() -> Dict[str, str]:
    ...
    if not os.path.exists(config_path):
        config_path = os.path.join(
            os.path.dirname(os.path.dirname(__file__)), "config", "device.sample.yaml"
        )
    ...
    try:
        ...
        config = {
            "mqtt": {"base_topics": {"publish": "sensors/office", "subscribe": "home/outdoor"}}
        }
