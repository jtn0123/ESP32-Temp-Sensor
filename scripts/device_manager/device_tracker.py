...
class DeviceState:
    ...
    def dev_mode_expired(self) -> bool:
        ...
        return (
            self.mode == DeviceMode.DEVELOPMENT
            and self.dev_mode_remaining_sec <= 0
            and self.dev_mode_started > 0
        )
...
class DeviceTracker:
    ...
    async def update_from_discovery(
        self, device_id: str, ip: str, hostname: str, room: str = "", version: str = ""
    ) -> DeviceState:
