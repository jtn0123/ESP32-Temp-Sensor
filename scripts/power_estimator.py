...
def main():
    ...
    p.add_argument(
        ...
        type=float,
        default=3500,
        help=("Battery capacity mAh (default 3500)"),
    )
    p.add_argument(
        "--sleep_mA",
        type=float,
        default=0.09,
        help=("Sleep current mA (default 0.09)"),
    )
    p.add_argument(
        "--active_mA",
        type=float,
        default=80,
        help=("Active current mA (default 80)"),
    )
    p.add_argument(
        "--awake_s",
        type=float,
        default=45,
        help=("Awake seconds per cycle (default 45)"),
    )
    p.add_argument(
        "--interval_s",
        type=float,
        default=7200,
        help=("Interval seconds (default 7200 = 2h)"),
    )
    args = p.parse_args()
