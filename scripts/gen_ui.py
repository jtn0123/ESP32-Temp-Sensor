...
def emit_web_js(spec: Dict[str, Any]) -> str:
    ...
    # Also expose FW_VERSION from generated_config.h via a tiny shim the sim can use if present.
    lines.append("  try { if (typeof window !== 'undefined') { window.UI_FW_VERSION = (window.UI_FW_VERSION||null); } } catch(e){}");
    lines.append("")
